...
const Blogs = () => {
    return (
        <div id="blogs-container" className="grid grid-cols-3 gap-6" >
            <div className="shadow-xl p-5 shadow-red-300">
                <h1 className="text-3xl font-semibold text-violet-500">What is the perpose of react router?</h1>
            ...
            <div className="shadow-xl p-1 shadow-red-300">
                <h1 className="text-3xl font-semibold text-violet-500">How does context api works in react js?</h1>
            ...
            <div className="shadow-lg p-8 shadow-red-300">
                <h1 className="text-3xl font-semibold text-violet-500">Introduction to useRef hooks in react js!</h1>
